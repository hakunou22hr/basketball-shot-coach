...
test('offline cache contains the player data module',async()=>{const worker=await readFile(new URL('../sw.js',import.meta.url),'utf8');assert.match(worker,/\.\/src\/player-store\.js/);assert.match(worker,/\.\/src\/video-analysis\.js/)});
